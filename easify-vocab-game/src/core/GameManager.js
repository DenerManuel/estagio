...
export class GameManager {
  ...
  _handlePIXIError(error) {
    ...
    this.handleCriticalFailure(); // Chama o método de falha crítica
  }
  ...
  async _prepareScreens() {
    try {
      this.screenManager = new ScreenManager(this.app, this.gameCategories);
  ...
  handleCriticalFailure() { // Caso ocorra um erro crítico, exibe uma mensagem de erro na tela
