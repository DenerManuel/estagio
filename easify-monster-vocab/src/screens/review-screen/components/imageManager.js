import { _configureImage } from "../../../utils/image/imageManager.js";

export function configureReviewScreenImages(images, imageContainer) {
  const imageOptions = _createImageOptions(imageContainer);
  _configureImage(images, imageContainer, imageOptions)
